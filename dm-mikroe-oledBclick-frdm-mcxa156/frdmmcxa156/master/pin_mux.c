...
void BOARD_InitPins(void)
{
    ...
    PORT_SetPinMux(PORT3, 29, kPORT_MuxAsGpio);
    PORT_SetPinMux(PORT3, 18, kPORT_MuxAsGpio);
}
...
- pin_list:
  - {pin_num: '84', peripheral: LPI2C0, signal: SCL, pin_signal: P0_17/LPI2C0_SCL/LPSPI0_PCS3/CT0_MAT1/UTICK_CAP3/FLEXIO0_D1, slew_rate: fast, open_drain: disable,
  ...
  - {pin_num: '83', peripheral: LPI2C0, signal: SDA, pin_signal: P0_16/LPI2C0_SDA/LPSPI0_PCS2/CT0_MAT0/UTICK_CAP2/FLEXIO0_D0, slew_rate: fast, open_drain: disable,
...
void I2C3_InitPins(void)
{
    ...
    const port_pin_config_t i2c_config = {/* Internal pull-up resistor is enabled */
                                                     kPORT_PullUp,
                                                     /* Low internal pull resistor value is selected. */
    ...
    /* PORT0_16 (pin 83) is configured as LPI2C0_SDA */
    PORT_SetPinConfig(PORT3, 28U, &i2c_config);
    /* PORT0_17 (pin 84) is configured as LPI2C0_SCL */
    PORT_SetPinConfig(PORT3, 27U, &i2c_config);
}
